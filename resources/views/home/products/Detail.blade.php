                ...
                <div class="s_product_text">
                    ...
                    <form action="{{ route('cart.add', $product->id) }}" method="get">
                        ...
                        <div class="product_count">
                            ...
                            <input type="number" name="quantity" min="1" value="1" title="Quantity:" class="input-text qty" oninput="validateInput(this)">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="review_box">
                            <h4>Add a Review</h4>
                            <p>Your Rating:</p>
                            <form class="row contact_form" action="{{ route('post.commnet',$product->id) }}" method="post" id="contactForm" novalidate="novalidate">
                                @csrf
                            <ul class="list">
                                <div id="rateYo1"></div>
