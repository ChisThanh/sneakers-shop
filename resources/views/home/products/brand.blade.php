    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-right mt-3">
                ...
                <a href="{{ route('brand', ['id' => $id, 'sort' => 'default']) }}" class="btn btn-outline-dark mx-1"><i class="fa-solid fa-not-equal"></i> Default</a>
                <a href="{{ route('brand', ['id' => $id, 'sort' => 'az']) }}" class="btn btn-outline-dark mx-1"><i class="fa-solid fa-arrow-up-a-z"></i> A-Z</a>
                <a href="{{ route('brand', ['id' => $id, 'sort' => 'za']) }}" class="btn btn-outline-dark mx-1"><i class="fa-solid fa-arrow-down-a-z"></i> Z-A</a>
                <a href="{{ route('brand', ['id' => $id, 'sort' => 'asc']) }}" class="btn btn-outline-dark mx-1"><i class="fa-solid fa-arrow-up-1-9"></i> Price asc</a>
                <a href="{{ route('brand', ['id' => $id, 'sort' => 'desc']) }}" class="btn btn-outline-dark mx-1"><i class="fa-solid fa-arrow-down-1-9"></i> Price desc</a>
            </div>
